...
export const sendWelcomeMail = async (email, name) => {
  const content = `
    ...
    <p style="
      ...
      margin-bottom:16px;
    ">
      We’re excited to have you onboard! Traveleo helps you plan trips,
      manage expenses, and stay within your budget effortlessly.
    </p>
...
export const sendTripReminderMail = async (email, name, trip) => {
  const content = `
    ...
    <div style="
      ...
      margin-bottom:16px;
    ">
      <p style="margin:0 0 6px; font-size:15px; color:#065f46;">
    ...
    <p style="
      ...
      margin:0;
    ">
      Start tracking your expenses early to enjoy a smooth, well-planned trip 🌴
    </p>
  `;
